...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-[#09090b] text-zinc-900 dark:text-white flex flex-col relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-blue-500/5 dark:bg-blue-900/10 blur-[150px] -z-10" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-indigo-500/5 dark:bg-indigo-900/10 blur-[120px] -z-10" />

      {/* Navigation Header */}
      <header className="w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between border-b border-zinc-200 dark:border-white/5 relative z-10">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-black flex items-center justify-center font-bold text-xl font-sans tracking-tighter">
            W
          </div>
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-6 py-20 flex flex-col items-center justify-center text-center relative z-10">
        ...
        {/* Sparkle Tag */}
        <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-white/10 text-zinc-600 dark:text-zinc-400 text-xs font-semibold mb-8 backdrop-blur-md">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 max-w-4xl leading-[1.1]">
          ...
          <span className="bg-gradient-to-r from-zinc-900 via-zinc-700 to-zinc-500 dark:from-white dark:via-zinc-200 dark:to-zinc-500 bg-clip-text text-transparent">Every Professional Skill</span>
        </h1>

        {/* Subtitle */}
        <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mb-12 font-light leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-20">
          <Link href="/register" className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2 group">
            Get Started As Candidate <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link href="/register" className="w-full sm:w-auto px-8 py-4 bg-zinc-200 hover:bg-zinc-300 text-zinc-800 dark:bg-zinc-900 dark:hover:bg-zinc-800 dark:text-white font-bold rounded-xl border border-zinc-300 dark:border-white/10 transition-all flex items-center justify-center gap-2">
            Hire Skills
          </Link>
        </div>
        ...
        <div className="w-full grid md:grid-cols-2 gap-8 mt-10">
          ...
          <Link href="/login" className="glass-card p-10 rounded-2xl text-left flex flex-col justify-between group">
            <div>
              <div className="w-12 h-12 rounded-xl bg-blue-600/10 text-blue-500 dark:text-blue-400 flex items-center justify-center mb-6 border border-blue-500/15">
                <Code size={24} />
              </div>
            ...
            <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-medium group-hover:gap-3 transition-all text-sm mt-4">
          ...
          <Link href="/login" className="glass-card p-10 rounded-2xl text-left flex flex-col justify-between group">
            <div>
              <div className="w-12 h-12 rounded-xl bg-amber-500/10 text-amber-500 dark:text-amber-400 flex items-center justify-center mb-6 border border-amber-500/15">
                <Wrench size={24} />
              </div>
            ...
            <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400 font-medium group-hover:gap-3 transition-all text-sm mt-4">
        ...
        {/* Feature Highlights */}
        <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-6 mt-20 border-t border-zinc-200 dark:border-white/5 pt-16">
          <div className="flex flex-col items-center">
            <div className="w-10 h-10 rounded-full bg-zinc-200/50 dark:bg-white/5 flex items-center justify-center text-blue-600 dark:text-blue-400 mb-3 border border-zinc-300 dark:border-white/5">
              <Sparkles size={18} />
            </div>
      ...
      {/* Footer */}
      <footer className="w-full border-t border-zinc-200 dark:border-white/5 py-10 text-center text-zinc-500 dark:text-zinc-600 text-sm relative z-10 bg-zinc-100/80 dark:bg-[#09090b]/80 backdrop-blur-md">
