...
export const RegisterSchema = z.object({
  ...
  cnic: z.string().regex(/^\d{5}-\d{7}-\d{1}$/, "CNIC must follow the format XXXXX-XXXXXXX-X"),
...
export const UpdateProfileSchema = z.object({
  ...
  phone: z.string().optional(),
  cnic: z.string().regex(/^\d{5}-\d{7}-\d{1}$/, "CNIC must follow the format XXXXX-XXXXXXX-X").optional(),
